...
def part1(filename):
    with open(filename, "r") as f:
        ...
        # what beats what
        battle_map: dict = {"Rock": "Scissors", "Scissors": "Paper", "Paper": "Rock"}
...
def part2(filename):
    with open(filename, "r") as f:
        ...
        lose_map: dict = {"Rock": "Scissors", "Scissors": "Paper", "Paper": "Rock"}

        # opp-move : move we need to win
        win_map: dict = {"Scissors": "Rock", "Paper": "Scissors", "Rock": "Paper"}
