...
class Part1:
    ...
    def makeRobot(self, blueprint: int) -> str:
        ...
        if (
            ...
            and self.resources["obsidian"][blueprint]
            >= self.robotCost["geode"][blueprint][1]
        ):
            self.resources["ore"][blueprint] -= self.robotCost["geode"][blueprint][0]
            self.resources["obsidian"][blueprint] -= self.robotCost["geode"][blueprint][
                1
            ]
            return "geode"
        ...
        # obsidian bot
            ...
            checkObsidian
            and self.resources["ore"][blueprint]
            >= self.robotCost["obsidian"][blueprint][0]
            and self.resources["clay"][blueprint]
            >= self.robotCost["obsidian"][blueprint][1]
        ):
            self.resources["ore"][blueprint] -= self.robotCost["obsidian"][blueprint][0]
            self.resources["clay"][blueprint] -= self.robotCost["obsidian"][blueprint][
                1
            ]
            return "obsidian"
        ...
        # clay bot
            ...
            checkClay
            and self.resources["ore"][blueprint] >= self.robotCost["clay"][blueprint]
        ):
        ...
        # ore bot
            ...
            checkOre
            and self.resources["ore"][blueprint] >= self.robotCost["ore"][blueprint]
        ):
